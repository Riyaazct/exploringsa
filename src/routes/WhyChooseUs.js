...
const WhyChooseUs = () => {
  return (
    <div className="mt-48 h-screen w-full relative">
      ...
      {/* CARDS CONTAINER */}
      <div className="text-blueText absolute top-32 grid grid-cols-2 p-1 z-20 sm:gap-y-5 lg:max-w-[90%] lg:left-[5%] xl:max-w-[80%] xl:left-[10%]">
        {/* CARD #1 */}
        <div className="h-full w-full p-3 bg-[#FFFFFF] bg-opacity-[85%] rounded-xl sm:max-w-[90%] mx-auto lg:max-w-[90%] 2xl:max-w-[90%]">
