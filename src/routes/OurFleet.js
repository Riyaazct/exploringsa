...
const OurFleet = () => {
  return (
    <section className="flex p-4 m-20 mx-auto bg-white rounded-md md:container lg:justify-center lg:max-w-6xl">
      <div className="flex flex-col items-center justify-center gap-5 lg:flex-row lg:gap-10 ">
        ...
        <div className="w-[95%] md:w-[85%] text-center md:max-w-3xl lg:text-left lg:max-w-2xl">
