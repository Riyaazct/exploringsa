...
const OurFleet = () => {
  return (
    <section>
      <div className="relative mt-28 h-[32vh] mb-[15%] md:mb-[7rem] lg:mb-[10rem] 2xl:mb-[14rem] 2xl:max-w-7xl mx-auto">
        <div
        ...
        <div
          className="bg-[#04420C] w-[45%] h-24 absolute top-[4.01rem] left-0 -z-10 flex
                       ...
                       2xl:w-[35rem] 2xl:left-16 2xl:top-[8.2rem]
                       "
        >
          <h1
