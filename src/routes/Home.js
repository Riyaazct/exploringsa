...
const Home = () => (
  <section className="md:flex">
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-offWhite text-center z-10 w-full max-w-[85%] md:top-52 ">
        ...
        <Link to="/services#services">
          <button
            ...
            md:hidden duration-500 animate-shake animate-twice animate-duration-[1000ms] animate-ease-in"
          >
    ...
    <div className="text-center my-12 text-2xl text-blueText font-semibold md:flex md:items-center md:m-auto xl:mx-auto xl:text-3xl 2xl:text-4xl xl:max-w-[55vw] md:flex-col">
      ...
      {/* BUTTON FOR SCREENS > 768 */}
      <Link to="/services#services">
        <button className="hidden md:block md:p-2 md:mt-6 md:text-lg sm:text-[1.3rem] md:opacity-95 md:hover:opacity-100 md:text-blueText md:font-semibold xl:p-3 xl:text-xl 2xl:font-extrabold animate-jump-in animate-once animate-duration-[1500ms] animate-ease-in-out">
          Explore our Services
        </button>
      </Link>
    </div>
