    ...
    <section className="lg:flex">
      <div className="relative lg:h-120vh">
        ...
        <div className="absolute top-[16rem] left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-offWhite text-center z-10 w-full max-w-[85%] sm:top-[20rem]">
          <h1 className="text-[1.625rem] leading-tight font-extrabold max-w-[90%] mx-auto md:text-4xl md:leading-tight lg:text-darkGreen sm:text-[2rem] xl:text-primary xl:text-6xl">
            {/* animate-fade-down animate-once animate-duration-1000 animate-ease-in */}
            Welcome to Exploring SA Transport and Tours
          </h1>
          <h2 className="text-[1rem] leading-tight font-bold max-w-[85%] mx-auto mt-2 sm:text-2xl md:max-w-lg md:my-3 xl:text-4xl xl:max-w-5xl">
            Your premier transportation and tourism provider in South
            Africa
          </h2>
          <p className="mt-7 mb-4 text-[0.9375rem] font-light leading-tight max-w-xs mx-auto px-2 md:text-xl md:max-w-lg md:leading-snug md:my-9 sm:text-base sm:max-w-md xl:text-4xl xl:max-w-[59rem]">
          ...
          <Link to="/services#services">
            ...
            duration-500 animate-shake animate-once animate-duration-[1500ms] animate-ease-in md:px-10 md:py-[0.6rem] xl:text-4xl xl:py-5 "
            >
              View Our Services
            </button>
          </Link>
        ...
        {/* IMAGE */}
        <div className="relative h-[90vh] sm:h-[95vh] md:h-[90vh] w-screen ">
          <img
            src={bgPathSm}
            style={
          ...
          <img
            ...
            width={"1250px"}
            height={"1050px"}
            className="hidden md:block md:!h-[80vh] xl:!h-[100vh]"
          />
          {/* background overlay */}
          <div className="w-full h-full bg-[#000000] bg-opacity-80 absolute top-0 md:h-[80vh] xl:h-[100vh]" />

          <h3
            className="text-[1.2rem] font-semibold text-[#3CCF4E] w-[70%] mx-auto leading-snug text-center mb-6
        animate-fade-right animate-once animate-duration-[1500ms] animate-delay-500 animate-ease-in-out up absolute bottom-4 left-20 md:text-[1.625rem] md:w-full md:left-3 sm:text-[1.45rem] md:bottom-24 xl:bottom-0 xl:mb-0 xl:text-5xl"
          >
