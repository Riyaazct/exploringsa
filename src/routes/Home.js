...
const Home = () => (
  <section className="lg:flex">
    <div className="relative">
      ...
      <div className="relative ">
        <img
          ...
          alt="Company vehicle"
          className="w-full h-full max-h-[90vh] md:max-h-[100vh]"
        />
    ...
    <div className="text-center my-12 text-2xl text-blueText font-semibold md:flex md:items-center md:m-auto xl:mx-auto xl:text-3xl 2xl:text-4xl xl:max-w-[55vw] md:flex-col">
      ...
      <h1 className="text-[1.0rem] sm:text-2xl font-extrabold lg:hidden animate-fade-right animate-once animate-duration-[1500ms] animate-delay-500 animate-ease-in-out up">
