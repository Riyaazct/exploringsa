    ...
    <section className="lg:flex">
      <div className="relative">
        ...
        <div className="absolute top-[15rem] left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-offWhite text-center z-10 w-full max-w-[85%] sm:top-[20rem]">
          ...
          <h2 className="text-[1rem] leading-tight font-bold max-w-[85%] mx-auto mt-2 sm:text-2xl md:max-w-lg md:my-3">
            Your premier transportation and tourism provider in South
            Africa
          </h2>
          <p className="mt-7 mb-4 text-[0.9375rem] font-light leading-tight max-w-xs mx-auto px-2 md:text-xl md:max-w-lg md:leading-snug md:my-9 sm:text-base sm:max-w-md">
