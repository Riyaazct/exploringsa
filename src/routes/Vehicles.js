  ...
  return (
    <>
      <section className="text-gray-600 body-font">
        <div className="flex flex-wrap px-5 py-24 mx-auto sm:container ">
          <div className="mx-auto lg:w-2/3 ">
            <div className="relative flex flex-wrap w-full px-10 py-32 mb-4 bg-gray-100">
              <img
                alt={data[0].alt}
                className="absolute inset-0 block object-cover object-center h-full opacity-25 w-[650px] mx-auto"
                src={data[0].image}
              />
